...
class Map : AbstractFragment<MapFragmentBinding?>() {
    ...
    protected override fun onInitBinding(binding: MapFragmentBinding) {
        binding.vm = viewModel
    }

    protected override fun onResumeBinding(binding: MapFragmentBinding) {
        viewModel!!.onResume()
    }

    protected override fun onDestroyBinding(binding: MapFragmentBinding) {
        viewModel!!.onDestroy()
    }
}